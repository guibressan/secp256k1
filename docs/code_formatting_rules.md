...
#### Exception for string literals

String literals must **never** be split across lines, even if they exceed
80 columns. Breaking a string prevents grepping for its content.
